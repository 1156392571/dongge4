...
//    $(function() {
    ...
    this.initWebUploader1 = function(webUploaderId, filePickerId, fileAddId, uploadUrl,ImageClass) {	
    	
        var $wrap = $(webUploaderId),
        
            // 图片容器
            $queue = $( '<ul id="filelist1" class="filelist"></ul>' ).appendTo( $wrap.find( '.queueList' ) ),
