...
<body>
	<div class="page-container" style="margin-top: 20px;">
		...
		<form:form id="inputForm" modelAttribute="tScUser" action="" method="post" class="form-horizontal">
			<form:input path="scName" htmlEscape="false" class="username" maxlength="255" placeholder="用户名(必填)"/>
			<form:password path="scPassword" htmlEscape="false" class="password" minlength="6" placeholder="密码(必填)"/>
			<form:input path="scSex" htmlEscape="false" class="scSex" maxlength="255" placeholder="性别"/>
			<form:input path="scPhone" htmlEscape="false" class="scPhone" maxlength="255" placeholder="手机号(必填)"/>
			<form:input path="scEmail" htmlEscape="false" class="scEmail" maxlength="255" placeholder="电子邮箱"/>
